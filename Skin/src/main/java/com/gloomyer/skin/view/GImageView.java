 ...
 * 皮肤ImageView
 */
public abstract class GImageView extends ImageView implements IChangeSkin {
    /**
     * 皮肤一的背景颜色和皮肤二的背景颜色状态
     * -1:未设置,0:颜色值,1:资源值
     */
    ...
    public GImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //白天文字颜色
        srcs[0] = typedArray.getResourceId(R.styleable.Skin_daySr, -1);
        ...
        srcs[1] = typedArray.getColor(R.styleable.Skin_nigSr, -1);
