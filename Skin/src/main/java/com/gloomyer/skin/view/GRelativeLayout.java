 ...
 * 皮肤RelativeLayout
 */
public class GRelativeLayout extends RelativeLayout implements IChangeSkin {
    /**
     * 皮肤一的背景颜色和皮肤二的背景颜色状态
     * -1:未设置,0:颜色值,1:资源值
     */
    ...
    public GRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
