 ...
 * 皮肤ViewGroup
 */
public abstract class GViewGroup extends ViewGroup implements IChangeSkin {
    /**
     * 皮肤一的背景颜色和皮肤二的背景颜色状态
     * -1:未设置,0:颜色值,1:资源值
     */
    ...
    public GViewGroup(Context context) {
        super(context);
    }

    public GViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
